...
Sub getconf()
  ...
  db=openopenBaseDatabase("10.0.0.139","Octopus","user","g4quantic9oct","REALbasic",true)
  if db<>nil then
...
Sub SendComplete(userAborted as Boolean)
  ...
  if nextstep="sendfile" then
    if bina.eof then
      ...
      me.write chr(13)+chr(10)
      me.write "--Octopus-Mail-Developped-by-LeonardoLVasconcellos"+chr(13)+chr(10)
      me.write chr(13)+chr(10)
      me.write chr(13)+chr(10)
      me.write chr(13)+chr(10)
  ...
  for i=1 to countfields(data,chr(10))
    ...
    case "334"
      if nextstep="user" then
        me.write encodeBase64(smtpuser,0,"")+crlf
        nextstep="passwd"
      elseif nextstep="passwd" then
        me.write encodeBase64(smtppasswd,0,"")+crlf
        NextStep="Mail"
      end if
    case "235"
    ...
    case "354"
      ...
      if attach then
        ...
        me.write chr(9)+"boundary="+chr(34)+"Octopus-Mail-Developped-by-LeonardoLVasconcellos"+chr(34)+crlf
      end if
      me.write "X-Mailer: Octopus Mail Notification. ver 1.0"+crlf
      me.write crlf
      if attach then
        me.write "--Octopus-Mail-Developped-by-LeonardoLVasconcellos"+crlf
